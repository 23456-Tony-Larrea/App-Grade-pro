...
interface FormEstudentProps {
  studentData?: any;
  mode: "insert" | "edit";
}

export default function FormStudent({ studentData, mode }: FormEstudentProps) {
  const [paso, setPaso] = useState(0);
  const [curso, setCurso] = useState(studentData?.curso || null);
  const [formData, setFormData] = useState({
    nombre: studentData?.nombre || "",
    segundoNombre: studentData?.segundoNombre || "",
    ...
    <Card className="w-full max-w-3xl mx-auto">
      ...
      >
        ...
        <h2 style={{ fontSize: "2rem", fontWeight: "bold" }}>
          {mode === "insert" ? "Insertar Estudiantes" : "Editar Estudiante"}
        </h2>
      </div>
      <Card>
      ...
      <Card className="flex justify-between">
        ...
        {paso < 1 ? (
          ...
          <Button
            ...
            label={mode === "insert" ? "Guardar" : "Actualizar"}
            className="ml-auto"
          />
        )}
      </Card>
