...
import { SubjectsService } from "./controllers/subjects/subjects.service";
import { SubjectsModule } from "./controllers/subjects/subjects.module";
import { CourseController } from "./routes/course/course.controller";
@Module({
  imports: [
    PermissionsModule,
    RolesModule,
  ...
  providers: [
    ...
    DesactivateUsersService,
    WelcomeUserService,
    ForgotUsernameService,
    DesactivateUserFalseService,
